...
SOURCE_FOLDERS = [
    "../balanceScripts/captchas/CASH_FRENZY",
    "../balanceScripts/captchas/CASH_MACHINE",
    "../balanceScripts/captchas/GAME_ROOM",
    "../balanceScripts/captchas/JOKER",
    "../balanceScripts/captchas/LUCKY_STARS",
    "../balanceScripts/captchas/MAFIA",
    "../balanceScripts/captchas/Mr._All_In_One",
    "../balanceScripts/captchas/NOBLE",
    "../balanceScripts/captchas/VEGAS_ROLL",
    "../balanceScripts/captchas/Win_Star",
    "../balanceScripts/captchas/WINNERS_CLUB",
    "../balanceScripts/captchas/WINSTAR",
]

DEST_FOLDER = "captcha_datasets/grupo2"  # Carpeta destino (dataset)
