...
SOURCE_FOLDERS = [
    "../balanceScripts/captchas/ORION_STARS",
    "../balanceScripts/captchas/FIRE_KIRIN",
    "../balanceScripts/captchas/PANDA_MASTER",
    "../balanceScripts/captchas/MILKY_WAY",
    "../balanceScripts/captchas/MOOLAH",
    "../balanceScripts/captchas/RIVER_MONSTER",
    "../balanceScripts/captchas/KRAKEN",
]

DEST_FOLDER = "captcha_datasets/grupo1"  # Carpeta destino (dataset)
